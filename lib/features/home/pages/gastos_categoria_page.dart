                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(item['nome']!, style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 13)),
                        Text(item['cat']!, style: const TextStyle(color: Colors.black54, fontSize: 11)),
                      ],
                    ),
                  ),
